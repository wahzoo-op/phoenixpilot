...
_AWARENESS_TIME = 35. * awareness_factor  # passive wheel touch total timeout
_AWARENESS_PRE_TIME_TILL_TERMINAL = 12. * awareness_factor
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 6. * awareness_factor
